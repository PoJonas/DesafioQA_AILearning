...
def test_cadastrar_usuario_valido(base_url):
...
def test_cadastrar_email_duplicado(base_url):
    payload = gerar_usuario()
...
def test_cadastrar_sem_email(base_url):
    payload = gerar_usuario()
    del payload["email"]
...
def test_cadastrar_sem_nome(base_url):
    payload = gerar_usuario()
    del payload["nome"]
...
def test_buscar_usuario_por_id(base_url):
    payload = gerar_usuario()
...
def test_excluir_usuario(base_url):
    payload = gerar_usuario()
